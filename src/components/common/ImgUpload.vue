...
<template>
    ...
    <!-- 保存修改 -->
    <el-row class="upload-container" style="margin:30px 0 20px 0">
        <el-button color="#ffcc00" @click="uploadPicture" class="btn">开始识别</el-button>
        <el-button type="info" @click="onCancel" class="btn">清空选择</el-button>
    </el-row>
</template>
